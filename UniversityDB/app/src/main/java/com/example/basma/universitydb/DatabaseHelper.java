 ...
 */
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + TABLE8_NAME +" (docID INTEGER PRIMARY KEY AUTOINCREMENT,docNAME TEXT,depNAME Text ," +
                "facID  INTEGER NOT NULL,FOREIGN KEY (facID) REFERENCES "+TABLE1_NAME +" (facID))");
        db.execSQL("INSERT INTO  "+TABLE8_NAME +" (docNAME,depNAME ,facID) VALUES('Islam ElShaarawy','Electrical',1)");
        db.execSQL("INSERT INTO  "+TABLE8_NAME +" (docNAME,depNAME ,facID) VALUES('Ahmed Bayiomy Zaki Ahmed','Electrical',1)");
        db.execSQL("INSERT INTO  "+TABLE8_NAME +" (docNAME,depNAME ,facID) VALUES('Hisham Eid','Civil',1)");
 ...
 */
    ...
    public  Cursor  getselectedstaffbydep(String name1,String name2) {
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor s = db.rawQuery("SELECT docNAME FROM "+TABLE8_NAME+ " a"+"  JOIN "+TABLE1_NAME+" b "+" ON a.facID=b.facID WHERE b.facNAME = ? AND a.depNAME= ? ", new String[] {name1,name2});
